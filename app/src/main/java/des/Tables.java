...
public class Tables {
	...
	static final int[] InverseInitialPermutation = {
	...
	static final int[] PC2 = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6,
	...
	static final int[] EP = { 32, 1, 2, 3, 4, 5, 4, 5, 6, 7,
	...
	static final int[] P = { 16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23,
			26, 5, 18, 31, 10, 2, 8, 24, 14, 32, 27,
			3, 9, 19, 13, 30, 6, 22, 11, 4, 25 };

	// S-box Table
	static final int[][][] sbox = { { { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6,
			12, 5, 9, 0, 7 },
